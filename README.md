About py-open-fonts-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-open-fonts-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8681&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-open-fonts-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-open-fonts` can be installed with `conda`:
...
```
mamba install py-open-fonts
```

It is possible to list all of the versions of `py-open-fonts` available on your platform with `conda`:
...
```
mamba search py-open-fonts --channel conda-forge
```
...
mamba repoquery search py-open-fonts --channel conda-forge

# List packages depending on `py-open-fonts`:
mamba repoquery whoneeds py-open-fonts --channel conda-forge

# List dependencies of `py-open-fonts`:
mamba repoquery depends py-open-fonts --channel conda-forge
```
